...
loaddVarNames = ['lambda', 'qext', 'refreal', 'refimag']
...
root_grp.createDimension('wavelength', Nlambda)
...
wavelength = root_grp.createVariable('lambda', 'f4', ('wavelength'))
wavelength.units = 'um'
...
for varNm in PMvarNms:
    PMvars[varNm] = root_grp.createVariable(varNm, 'f8', ('sizeBin', 'wavelength', 'angle'))
    PMvars[varNm].units = 'sr-1'
    PMvars[varNm].long_name = varNm + 'phase matrix element' 
bext = root_grp.createVariable('bext', 'f8', ('sizeBin', 'wavelength'))
bext.units = 'm-1'
bext.long_name = 'extinction coefficient'
bsca = root_grp.createVariable('bsca', 'f8', ('sizeBin', 'wavelength'))
bsca.units = 'm-1'
bsca.long_name = 'scattering coefficient'
refreal = root_grp.createVariable('refreal', 'f8', ('sizeBin', 'wavelength'))
refreal.units = 'none'
refreal.long_name = 'real refractive index'
reafimag = root_grp.createVariable('reafimag', 'f8', ('sizeBin', 'wavelength'))
refreal.units = 'none'
refreal.long_name = 'imaginary refractive index'
...
#            print('%s>>> bin: %d - lInd: %d - rv[rslt]: %4.2f um - lambda[rslt]: %5.3f um' % (varNm, binInd, l, rslt['rv'][0], rslt['lambda'][i]))
